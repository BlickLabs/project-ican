...
function doSomething(scroll_pos) {
  if (window.location.pathname === '/index.html' || window.location.pathname === '/home.html' || window.location.pathname === '/' || window.location.pathname === '/project-ican/index.html' || window.location.pathname === '/project-ican/home.html' || window.location.pathname === '/project-ican/') {
    if (scroll_pos > 30) {
